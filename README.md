...
## Supported OTA image spec

This package currently only supports the legacy OTA image format(generated by [ota-metadata](https://github.com/tier4/ota-metadata)), and the new OTA image v1 format(generated by [ota-image-builder](https://github.com/tier4/ota-image-builder)).
